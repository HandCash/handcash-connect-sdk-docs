...
- [User Authorization](user-authorization.md)
  - [Overview](user-authorization.md#overview)
  - [Permissions](user-authorization.md#permissions)
  - [Your app authorization](user-authorization.md#your-app-authorization)

- [User Profile](user-profile.md)
  - [Balance](user-profile.md#balance)
  - [Public profile](user-profile.md#public-profile)
  - [Private profile](user-profile.md#private-profile)
  - [Preferences](user-profile.md#preferences)

- [Instant Payments](payments.md)
  - [Simple Payment](payments.md#simple-payment)
  - [Pay to multiple people](payments.md#pay-to-multiple-people)
